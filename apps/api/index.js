...
function mountAllRoutes(voiceCatalog, voiceWriteService, voiceOnboardingService) {
  app.use('/api/tts', ttsRoutes);
  app.use('/api/voices', createVoiceManageRoutes(voiceCatalog, voiceWriteService, voiceOnboardingService));
...
async function start() {
  ...
  const voiceCatalog = serviceContainer.get('voiceCatalog');
  ...
  mountAllRoutes(voiceCatalog, voiceWriteService, voiceOnboardingService);
